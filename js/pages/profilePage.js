export function renderProfilePage(app) {
    ...
    <section class="profile-page">
      <div class="profile-box">
        ...
        <div class="profile-form">
          ...
          <label for="profile-name">Нэр</label>
          <input type="text" id="profile-name" value="${user.name}" />

          <label for="profile-email">И-мэйл</label>
          <input type="email" id="profile-email" value="${user.email}" disabled />

          <label for="profile-password">Шинэ нууц үг</label>
          <input
            type="password"
            id="profile-password"
          ...
          <label for="profile-password-confirm">Нууц үг давтах</label>
          <input
            type="password"
          ...
          <p class="profile-success hidden" id="profile-success">
            Амжилттай хадгалагдлаа!
          </p>

          <button class="profile-submit" id="profile-save">
            Хадгалах
          </button>
        </div>
      </div>
  ...
  document.getElementById("profile-save").addEventListener("click", async () => {
    ...
    if (!name) {
      errorEl.textContent = "Нэр хоосон байж болохгүй";
